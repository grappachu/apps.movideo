...
Please read these guidelines before contributing to Movideo:
...
If you have questions about how to use Movideo, please read the
[Movideo documentation][documentation].
...
- Check that new and updated code follows Movideo's existing code formatting and naming standard
- Run Movideo's unit tests to ensure no existing functionality has been affected
...
By contributing your code to Movideo you grant Davide Prenassi a non-exclusive, irrevocable, worldwide,
...
Davide Prenassi acknowledges that, except as explicitly described in this Agreement, any Contribution which
you provide is on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, EITHER EXPRESS OR IMPLIED,
INCLUDING, WITHOUT LIMITATION, ANY WARRANTIES OR CONDITIONS OF TITLE, NON-INFRINGEMENT, MERCHANTABILITY, OR FITNESS
FOR A PARTICULAR PURPOSE.


[home]: https://github.com/grappachu/apps.movideo 
[github]: https://github.com/grappachu/apps.movideo
